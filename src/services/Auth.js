...
export default class Auth {
	...
	/**
	 * Check for API authentication, and if missing send the user to login.
	 */
	requireAPIAuth() {
	...
	/**
	 * Create a user API session using Auth0, with variables in localstorage.
	 * @param {*} authResult The result provided by Auth0 parseHash function
	 */
	...
	/**
	 * Points the browser to Auth0 Cashier authentication page. Details, including callback page, are set in the constructor of this service class.
	 */
	login() {
	...
	/**
	 * Points the browser to Auth0 Cashier API authentication page. Details, including callback page, are set in the constructor of this service class.
	 */
	loginAPI() {
